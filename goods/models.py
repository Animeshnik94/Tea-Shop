...
class Products(models.Model):
    ...
    # Внешние кдючи
    category = models.ForeignKey(to=Categories, on_delete=models.CASCADE, verbose_name='Категория') # Внешний ключ. FK categories. PROTECT-если все связанные товары не удалены, удалить категорию невозможно
